...
def parse_args():
    ...
    # /data/m1/lim22/multimedia-common-space/Multimedia-Common-Space/ace/JMEE_data/head
    parser.add_argument('vocab_dir', help='Output vocab directory.')
    # /data/m1/lim22/multimedia-common-space/Multimedia-Common-Space/ace/vocab
    parser.add_argument('--glove_dir', default='/data/m1/lim22/env/glove', help='GloVe directory.')
...
def main():
    ...
    # input files
    train_file = args.data_dir + '/JMEE_train.json'
    dev_file = args.data_dir + '/JMEE_dev.json'
    test_file = args.data_dir + '/JMEE_test.json'
