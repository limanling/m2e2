...
from src.dataflow.torch.Sentence import Sentence_ace
...
class ACE2005Dataset(Corpus):
    ...
    def __init__(self, path, fields, amr=False, keep_events=None, only_keep=False, **kwargs):
        '''
        ...
        super(ACE2005Dataset, self).__init__(path, fields, amr, **kwargs)
