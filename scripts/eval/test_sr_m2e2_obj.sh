...
checkpoint="/scratch/manling2/mm-event-graph/log/joint/obj_gcn2/model/model_sr_37.pt"
checkpoint_params="/scratch/manling2/mm-event-graph/log/joint/obj_gcn2/sr_hyps.json"
